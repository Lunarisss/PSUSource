...
namespace Obfuscator.Obfuscation.Generation
{
	public class PremiumScriptBuilder
	{
		...
		{
			bool flag = PremiumScriptBuilder.Random.Next(0, 2) == 0;
			List<string> result;
			if (flag)
			{
				long Index = (long)PremiumScriptBuilder.Random.Next(0, 1000000000);
				while (this.UsedIndicies.Contains(Index))
				{
					Index = (long)PremiumScriptBuilder.Random.Next(0, 1000000000);
				}
		...
		private PremiumScriptBuilder.Expression AddExpression(dynamic Value)
		{
			if (PremiumScriptBuilder.<>o__18.<>p__1 == null)
			{
				PremiumScriptBuilder.<>o__18.<>p__1 = CallSite<Func<CallSite, object, bool>>.Create(Binder.UnaryOperation(CSharpBinderFlags.None, ExpressionType.IsTrue, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
				{
					CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
				}));
			}
			Func<CallSite, object, bool> target = PremiumScriptBuilder.<>o__18.<>p__1.Target;
			CallSite <>p__ = PremiumScriptBuilder.<>o__18.<>p__1;
			if (PremiumScriptBuilder.<>o__18.<>p__0 == null)
			{
				PremiumScriptBuilder.<>o__18.<>p__0 = CallSite<Func<CallSite, Dictionary<object, PremiumScriptBuilder.Expression>, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "ContainsKey", null, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
				{
					CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, null),
					CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
				}));
			}
			bool flag = target(<>p__, PremiumScriptBuilder.<>o__18.<>p__0.Target(PremiumScriptBuilder.<>o__18.<>p__0, this.ExpressionMap, Value));
			PremiumScriptBuilder.Expression result;
			if (flag)
			{
				if (PremiumScriptBuilder.<>o__18.<>p__3 == null)
				{
					PremiumScriptBuilder.<>o__18.<>p__3 = CallSite<Func<CallSite, object, PremiumScriptBuilder.Expression>>.Create(Binder.Convert(CSharpBinderFlags.None, typeof(PremiumScriptBuilder.Expression), typeof(PremiumScriptBuilder)));
				}
				Func<CallSite, object, PremiumScriptBuilder.Expression> target2 = PremiumScriptBuilder.<>o__18.<>p__3.Target;
				CallSite <>p__2 = PremiumScriptBuilder.<>o__18.<>p__3;
				if (PremiumScriptBuilder.<>o__18.<>p__2 == null)
				{
					PremiumScriptBuilder.<>o__18.<>p__2 = CallSite<Func<CallSite, Dictionary<object, PremiumScriptBuilder.Expression>, object, object>>.Create(Binder.GetIndex(CSharpBinderFlags.None, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
					{
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, null),
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
					}));
				}
				result = target2(<>p__2, PremiumScriptBuilder.<>o__18.<>p__2.Target(PremiumScriptBuilder.<>o__18.<>p__2, this.ExpressionMap, Value));
			}
			else
			{
				PremiumScriptBuilder.Expression Expression = new PremiumScriptBuilder.Expression();
				...
				if (flag2)
				{
					...
					if (PremiumScriptBuilder.<>o__18.<>p__4 == null)
					{
						PremiumScriptBuilder.<>o__18.<>p__4 = CallSite<Func<CallSite, Dictionary<long, PremiumScriptBuilder.Expression>, object, PremiumScriptBuilder.Expression, object>>.Create(Binder.SetIndex(CSharpBinderFlags.None, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
						{
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, null),
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null),
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, null)
					...
					PremiumScriptBuilder.<>o__18.<>p__4.Target(PremiumScriptBuilder.<>o__18.<>p__4, this.NumberExpressionMap, Value, Expression);
				}
				this.Expressions.Add(Expression);
				if (PremiumScriptBuilder.<>o__18.<>p__5 == null)
				{
					PremiumScriptBuilder.<>o__18.<>p__5 = CallSite<Func<CallSite, Dictionary<object, PremiumScriptBuilder.Expression>, object, PremiumScriptBuilder.Expression, object>>.Create(Binder.SetIndex(CSharpBinderFlags.None, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
					{
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, null),
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null),
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, null)
				...
				PremiumScriptBuilder.<>o__18.<>p__5.Target(PremiumScriptBuilder.<>o__18.<>p__5, this.ExpressionMap, Value, Expression);
				result = Expression;
			}
			return result;
		}
		...
		private string ToExpression(dynamic Value, string Type)
		{
			...
			if (flag)
			{
				if (PremiumScriptBuilder.<>o__19.<>p__1 == null)
				{
					PremiumScriptBuilder.<>o__19.<>p__1 = CallSite<Func<CallSite, object, byte[]>>.Create(Binder.Convert(CSharpBinderFlags.None, typeof(byte[]), typeof(PremiumScriptBuilder)));
				}
				Func<CallSite, object, byte[]> target = PremiumScriptBuilder.<>o__19.<>p__1.Target;
				CallSite <>p__ = PremiumScriptBuilder.<>o__19.<>p__1;
				if (PremiumScriptBuilder.<>o__19.<>p__0 == null)
				{
					PremiumScriptBuilder.<>o__19.<>p__0 = CallSite<Func<CallSite, Encoding, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "GetBytes", null, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
					{
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, null),
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
					}));
				}
				byte[] Bytes = target(<>p__, PremiumScriptBuilder.<>o__19.<>p__0.Target(PremiumScriptBuilder.<>o__19.<>p__0, PremiumScriptBuilder.LuaEncoding, Value));
				string String = "\"";
				bool IsString = true;
				foreach (byte Byte in Bytes)
				{
					int num = PremiumScriptBuilder.Random.Next(0, 2);
					int num2 = num;
					if (num2 != 0)
					{
			...
			else
			{
				...
				{
					string str = "T";
					if (PremiumScriptBuilder.<>o__19.<>p__4 == null)
					{
						PremiumScriptBuilder.<>o__19.<>p__4 = CallSite<Func<CallSite, object, List<string>>>.Create(Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof(List<string>), typeof(PremiumScriptBuilder)));
					}
					Func<CallSite, object, List<string>> target2 = PremiumScriptBuilder.<>o__19.<>p__4.Target;
					CallSite <>p__2 = PremiumScriptBuilder.<>o__19.<>p__4;
					if (PremiumScriptBuilder.<>o__19.<>p__3 == null)
					{
						PremiumScriptBuilder.<>o__19.<>p__3 = CallSite<Func<CallSite, object, object>>.Create(Binder.GetMember(CSharpBinderFlags.None, "Indicies", typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
						{
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
						}));
					}
					Func<CallSite, object, object> target3 = PremiumScriptBuilder.<>o__19.<>p__3.Target;
					CallSite <>p__3 = PremiumScriptBuilder.<>o__19.<>p__3;
					if (PremiumScriptBuilder.<>o__19.<>p__2 == null)
					{
						PremiumScriptBuilder.<>o__19.<>p__2 = CallSite<Func<CallSite, PremiumScriptBuilder, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.InvokeSimpleName, "AddExpression", null, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
						{
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, null),
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
						}));
					}
					result = str + target2(<>p__2, target3(<>p__3, PremiumScriptBuilder.<>o__19.<>p__2.Target(PremiumScriptBuilder.<>o__19.<>p__2, this, Value))).Random<string>();
				}
				else
				{
					...
					{
						string str2 = "T";
						if (PremiumScriptBuilder.<>o__19.<>p__7 == null)
						{
							PremiumScriptBuilder.<>o__19.<>p__7 = CallSite<Func<CallSite, object, List<string>>>.Create(Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof(List<string>), typeof(PremiumScriptBuilder)));
						}
						Func<CallSite, object, List<string>> target4 = PremiumScriptBuilder.<>o__19.<>p__7.Target;
						CallSite <>p__4 = PremiumScriptBuilder.<>o__19.<>p__7;
						if (PremiumScriptBuilder.<>o__19.<>p__6 == null)
						{
							PremiumScriptBuilder.<>o__19.<>p__6 = CallSite<Func<CallSite, object, object>>.Create(Binder.GetMember(CSharpBinderFlags.None, "Indicies", typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
							{
								CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
							}));
						}
						Func<CallSite, object, object> target5 = PremiumScriptBuilder.<>o__19.<>p__6.Target;
						CallSite <>p__5 = PremiumScriptBuilder.<>o__19.<>p__6;
						if (PremiumScriptBuilder.<>o__19.<>p__5 == null)
						{
							PremiumScriptBuilder.<>o__19.<>p__5 = CallSite<Func<CallSite, PremiumScriptBuilder, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.InvokeSimpleName, "AddExpression", null, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
							{
								CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, null),
								CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
							}));
						}
						result = str2 + target4(<>p__4, target5(<>p__5, PremiumScriptBuilder.<>o__19.<>p__5.Target(PremiumScriptBuilder.<>o__19.<>p__5, this, Value))).Random<string>();
					}
					else
					{
						result = "";
		...
		public string BasicRandomizeNumberStatement(long Number)
		{
			...
			if (flag)
			{
				int XOR = PremiumScriptBuilder.Random.Next(0, 1000000000);
				Number ^= (long)XOR;
				Replacement = string.Format("BitXOR({0}, {1})", XOR, Number);
			}
			else
			{
				bool flag2 = this.NumberExpressions.Count > 0 && PremiumScriptBuilder.Random.Next(0, 2) == 0;
				if (flag2)
				{
					PremiumScriptBuilder.Expression Expression = this.NumberExpressions.Random<PremiumScriptBuilder.Expression>();
					long num = Number;
					if (PremiumScriptBuilder.<>o__22.<>p__0 == null)
					{
						PremiumScriptBuilder.<>o__22.<>p__0 = CallSite<Func<CallSite, object, long>>.Create(Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof(long), typeof(PremiumScriptBuilder)));
					}
					Number = (num ^ PremiumScriptBuilder.<>o__22.<>p__0.Target(PremiumScriptBuilder.<>o__22.<>p__0, Expression.Data));
					Replacement = string.Format("BitXOR({0}, T{1})", Number, Expression.Indicies.Random<string>());
				}
				else
				{
					long XOR2 = (long)PremiumScriptBuilder.Random.Next(0, 1000000000);
					PremiumScriptBuilder.Expression Expression2 = this.AddExpression(XOR2);
					Number ^= XOR2;
		...
		public string RandomizeNumberStatement(long Number)
		{
			...
			{
				switch (PremiumScriptBuilder.Random.Next(0, 7))
				{
				case 0:
				{
				...
				case 3:
				{
					NumberEquation NumberEquation4 = new NumberEquation(PremiumScriptBuilder.Random.Next(3, 6));
				...
				case 5:
				{
					NumberEquation NumberEquation5 = new NumberEquation(PremiumScriptBuilder.Random.Next(3, 6));
		...
		public PremiumScriptBuilder(Chunk HeadChunk, ObfuscationContext ObfuscationContext, ObfuscationSettings ObfuscationSettings, List<VOpCode> Virtuals)
		{
			...
			int Count = PremiumScriptBuilder.Random.Next(5, 15);
			for (int I = 0; I < Count; I++)
			{
				this.NumberEquations.Add((long)PremiumScriptBuilder.Random.Next(0, 1000000000), new NumberEquation(PremiumScriptBuilder.Random.Next(3, 6)));
			}
		}
		...
		private void GenerateDeserializer()
		{
			...
			for (int i = 0; i < chunkSteps.Length; i++)
			{
				...
				case ChunkStep.ParameterCount:
					this.Deserializer = this.Deserializer + "\n\t" + PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0("local ParameterCount = gBits8(PrimaryXORKey);", "local ParameterCount = Value;", InlinedGetBits34, "PrimaryXORKey") + "\n";
					break;
				case ChunkStep.Instructions:
				{
					...
					{
						PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0("for Index = 0, gBits32(PrimaryXORKey) - 1, 1 do", "for Index = 0, Value - 1, 1 do", InlinedGetBits32, "PrimaryXORKey"),
						PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0("local Type = gBits8(PrimaryXORKey);", "local Type = Value;", InlinedGetBits34, "PrimaryXORKey"),
						this.ObfuscationContext.ConstantMapping[1],
						PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0("local Bool = gBits8(PrimaryXORKey);", "local Bool = Value;", InlinedGetBits34, "PrimaryXORKey"),
						this.ObfuscationContext.ConstantMapping[2],
						PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0("local Left = gBits32(PrimaryXORKey);", "local Left = Value;", InlinedGetBits32, "PrimaryXORKey"),
						PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0("local Right = gBits32(PrimaryXORKey);", "local Right = Value;", InlinedGetBits32, "PrimaryXORKey"),
						this.ObfuscationContext.ConstantMapping[3],
						PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0("local Length = gBits32(PrimaryXORKey);", "local Length = Value;", InlinedGetBits32, "PrimaryXORKey"),
					...
					this.Deserializer = string.Concat(new string[]
					{
						this.Deserializer,
						"\n\n                            ",
						PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0("local Count = gBits32(PrimaryXORKey);", "local Count = Value;", InlinedGetBits32, "PrimaryXORKey"),
						" \n                            for Index = 0, Count - 1, 1 do Instructions[Index] = ({}); end;\n\n                            for Index = 0, Count - 1, 1 do\n                                ",
						PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0("local InstructionData = gBits8(PrimaryXORKey);", "local InstructionData = Value;", InlinedGetBits34, "PrimaryXORKey"),
						...
						case InstructionType.ABC:
						{
							...
							for (int j = 0; j < instructionSteps.Length; j++)
							{
								...
								case InstructionStep.Enum:
									this.Deserializer += PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0(" Enum = (gBits8(PrimaryXORKey));", " Enum = (Value);", InlinedGetBits34, "PrimaryXORKey");
									break;
								case InstructionStep.A:
									this.Deserializer += PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0(" A = (gBits16(PrimaryXORKey));", " A = (Value);", InlinedGetBits33, "PrimaryXORKey");
									break;
								case InstructionStep.B:
									this.Deserializer += PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0(" B = (gBits16(PrimaryXORKey));", " B = (Value);", InlinedGetBits33, "PrimaryXORKey");
									break;
								case InstructionStep.C:
									this.Deserializer += PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0(" C = (gBits16(PrimaryXORKey));", " C = (Value);", InlinedGetBits33, "PrimaryXORKey");
									break;
								}
							}
							break;
						...
						case InstructionType.ABx:
						{
							...
							for (int k = 0; k < instructionSteps2.Length; k++)
							{
								...
								case InstructionStep.A:
									...
									break;
								case InstructionStep.B:
									this.Deserializer += PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0(" B = (gBits32(PrimaryXORKey));", " B = (Value);", InlinedGetBits32, "PrimaryXORKey");
									break;
								}
							}
							break;
						...
						case InstructionType.AsBx:
						{
							...
							for (int l = 0; l < instructionSteps3.Length; l++)
							{
								...
								case InstructionStep.A:
									...
									break;
								case InstructionStep.B:
									this.Deserializer += PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0(" B = Instructions[(gBits32(PrimaryXORKey))];", " B = (Value);", InlinedGetBits32, "PrimaryXORKey");
									break;
								}
							}
							break;
						...
						case InstructionType.AsBxC:
						{
							...
							for (int m = 0; m < instructionSteps4.Length; m++)
							{
								...
								case InstructionStep.A:
									...
									break;
								case InstructionStep.B:
									this.Deserializer += PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0(" B = Instructions[(gBits32(PrimaryXORKey))];", " B = Instructions[(Value)];", InlinedGetBits32, "PrimaryXORKey");
									break;
								case InstructionStep.C:
									this.Deserializer += PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0(" C = (gBits16(PrimaryXORKey));", " C = (Value);", InlinedGetBits33, "PrimaryXORKey");
									break;
				...
				case ChunkStep.Chunks:
					this.Deserializer = this.Deserializer + "\n\t" + PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0("for Index = 0, gBits32(PrimaryXORKey) - 1, 1 do", "for Index = 0, Value - 1, 1 do", InlinedGetBits32, "PrimaryXORKey") + " Functions[Index] = Deserialize(); end;\n";
					break;
				case ChunkStep.StackSize:
					this.Deserializer = this.Deserializer + "\n\t" + PremiumScriptBuilder.<GenerateDeserializer>g__GetInlinedOrDefault|27_0("local StackSize = gBits16(PrimaryXORKey);", "local StackSize = Value;", InlinedGetBits33, "PrimaryXORKey") + "\n";
					break;
				}
			}
			this.Deserializer = string.Concat(new string[]
		...
		private void GenerateVM()
		{
			this.VM = string.Concat(new string[]
			{
				...
				string.Join("\n", new List<string>
				{
					...
					"\t\tlocal lUpValues = ({});",
					string.Format("\t\tlocal VMKey = ({0});", PremiumScriptBuilder.Random.Next(0, 1000000000)),
			...
			this.VM += this.<GenerateVM>g__GetString|28_2(Enumerable.Range(0, this.Virtuals.Count).ToList<int>());
		...
		private void GenerateHeader()
		{
			...
			this.Variables = string.Format("\n\nlocal GetFEnv = ((getfenv) or (function(...) return (_ENV); end));\nlocal Storage, _, Environment = ({{}}), (\"\"), (GetFEnv(1));\n\nlocal bit32 = ((Environment[{0}]) or (Environment[{1}]) or ({{}})); \nlocal BitXOR = (((bit32) and (bit32[{2}])) or (function(A, B) local P, C = 1, 0; while ((A > 0) and (B > 0)) do local X, Y = A % 2, B % 2; if X ~= Y then C = C + P; end; A, B, P = (A - X) / 2, (B - Y) / 2, P * 2; end; if A < B then A = B; end; while A > 0 do local X = A % 2; if X > 0 then C = C + P; end; A, P =(A - X) / 2, P * 2; end; return (C); end));\n\nlocal MOD = (2 ^ 32);\nlocal MODM = (MOD - 1);\nlocal BitSHL, BitSHR, BitAND;\n\n{3}\n\n{4}\n\n{5}\n\n{6}\n\n{7}\n\n{8}\n\nif ((not (Environment[{9}])) and (not (Environment[{10}]))) then\n\n{11}\n\nend;\n\n{12}\n\n{13} \n\nEnvironment[{14}] = bit32;\n\nlocal PrimaryXORKey = ({15});\n\n{16}\n\nlocal F = (#TEXT + 165); local G, Dictionary = ({{}}), ({{}}); for H = 0, F - 1 do local Value = Character(H); G[H] = Value; Dictionary[H] = Value; Dictionary[Value] = H; end;\nlocal ByteString, Position = (function(ByteString) local X, Y, Z = Byte(ByteString, 1, 3); if ((X + Y + Z) ~= 248) then PrimaryXORKey = PrimaryXORKey + {17}; F = F + {18}; end; ByteString = SubString(ByteString, 5); {19} local C, D, E = (\"\"), (\"\"), ({{}}); local I = 1; local function K() local L = ToNumber(SubString(ByteString, I, I), 36); I = I + 1; local M = ToNumber(SubString(ByteString, I, I + L - 1), 36); I = I + L; return (M); end; C = Dictionary[K()]; E[1] = C; while (I < #ByteString) do local N = K(); if G[N] then D = G[N]; else D = C .. SubString(C, 1, 1); end; G[F] = C .. SubString(D, 1, 1); E[#E + 1], C, F = D, D, F + 1; end; return (Concatenate(E)); end)(PSU_BYTECODE), (#TEXT - 90);", new object[]
			{
				...
				this.GetLuaGeneration(),
				PremiumScriptBuilder.Random.Next(0, 256),
				PremiumScriptBuilder.Random.Next(0, 256),
				ByteCodeFormattingTable
			});
		...
		private string GenerateLoader(string Source)
		{
			...
			{
				"\nPSU_LUA_GENERATION\n\nlocal Environment = getfenv();\n\nlocal ToNumber = Environment[\"\\",
				string.Join<byte>("\\", PremiumScriptBuilder.LuaEncoding.GetBytes("tonumber")),
				"\"]; \n\nPSU_LUA_GENERATION\n\nlocal SubString = (\"\")[\"\\",
				string.Join<byte>("\\", PremiumScriptBuilder.LuaEncoding.GetBytes("sub")),
				"\"]; \nlocal Byte = (\"\")[\"\\",
				string.Join<byte>("\\", PremiumScriptBuilder.LuaEncoding.GetBytes("byte")),
				"\"]; \nlocal Character = (\"\")[\"\\",
				string.Join<byte>("\\", PremiumScriptBuilder.LuaEncoding.GetBytes("char")),
				"\"]; \n\nlocal Concatenate = Environment[\"\\",
				string.Join<byte>("\\", PremiumScriptBuilder.LuaEncoding.GetBytes("table")),
				"\"][\"\\",
				string.Join<byte>("\\", PremiumScriptBuilder.LuaEncoding.GetBytes("concat")),
				"\"]; \n\nlocal LoadString = ((Environment[\"\\",
				string.Join<byte>("\\", PremiumScriptBuilder.LuaEncoding.GetBytes("loadstring")),
				"\"]) or (Environment[\"\\",
				string.Join<byte>("\\", PremiumScriptBuilder.LuaEncoding.GetBytes("load")),
				"\"]));\n\nlocal F = (256);\nlocal G, Dictionary = ({}), ({}); \nfor H = 0, F - 1 do local Value = Character(H); G[H] = Value; Dictionary[H] = Value; Dictionary[Value] = H; end; \n\nPSU_LUA_GENERATION\n\nlocal bit32 = ((Environment[\"\\",
				string.Join<byte>("\\", PremiumScriptBuilder.LuaEncoding.GetBytes("bit32")),
				"\"]) or (Environment[\"\\",
				string.Join<byte>("\\", PremiumScriptBuilder.LuaEncoding.GetBytes("bit")),
				"\"]) or ({})); \nlocal BitXOR = (((bit32) and (bit32[\"\\",
				string.Join<byte>("\\", PremiumScriptBuilder.LuaEncoding.GetBytes("bxor")),
				"\"])) or (function(A, B) local P, C = 1, 0; while ((A > 0) and (B > 0)) do local X, Y = A % 2, B % 2; if X ~= Y then C = C + P; end; A, B, P = (A - X) / 2, (B - Y) / 2, P * 2; end; if A < B then A = B; end; while A > 0 do local X = A % 2; if X > 0 then C = C + P; end; A, P =(A - X) / 2, P * 2; end; return (C); end));\n\nlocal PrimaryXORKey = (BitXOR(",
				Utility.IntegerToTable(0),
				", ",
				Utility.IntegerToTable(0),
		...
		public string BuildScript(string Location)
		{
			...
			this.Variables += " end; end;";
			string VMTable = "";
			this.Expressions.Shuffle<PremiumScriptBuilder.Expression>();
			...
			bool debugMode = this.ObfuscationSettings.DebugMode;
			if (debugMode)
			{
				File.WriteAllText(Path.Combine(Location, "VM_pass1.lua"), Source);
			}
			...
			Process.Start();
			Process.WaitForExit();
			Source = File.ReadAllText(Path.Combine(Location, "Output.lua"), PremiumScriptBuilder.LuaEncoding).Replace("\n", " ");
			Source = Source.Replace("[.", "[0.");
			string tempsource = Source.Replace("PSU_BYTECODE", this.ObfuscationContext.ByteCode).Replace("PSU_FORMAT_TABLE", this.ObfuscationContext.FormatTable);
			File.WriteAllText(Path.Combine(Location, "Output.lua"), tempsource);
			bool debugMode2 = this.ObfuscationSettings.DebugMode;
			if (debugMode2)
			{
				File.WriteAllText(Path.Combine(Location, "Output_pass1.lua"), tempsource);
			}
			Utility.NoExtraString = false;
			string Script = File.ReadAllText(Path.Combine(Location, "Output.lua"), PremiumScriptBuilder.LuaEncoding);
			Source = this.GenerateLoader(Script);
			List<byte> Bytes = PremiumScriptBuilder.LuaEncoding.GetBytes(Script).ToList<byte>();
			List<byte> Initial = new List<byte>();
			foreach (PremiumScriptBuilder.Expression Expression in this.Expressions)
			{
				...
				if (PremiumScriptBuilder.<>o__31.<>p__7 == null)
				{
					PremiumScriptBuilder.<>o__31.<>p__7 = CallSite<Func<CallSite, object, bool>>.Create(Binder.UnaryOperation(CSharpBinderFlags.None, ExpressionType.IsTrue, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
					{
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
					}));
				}
				Func<CallSite, object, bool> target = PremiumScriptBuilder.<>o__31.<>p__7.Target;
				CallSite <>p__ = PremiumScriptBuilder.<>o__31.<>p__7;
				if (PremiumScriptBuilder.<>o__31.<>p__1 == null)
				{
					PremiumScriptBuilder.<>o__31.<>p__1 = CallSite<Func<CallSite, object, Type, object>>.Create(Binder.BinaryOperation(CSharpBinderFlags.None, ExpressionType.Equal, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
					{
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null),
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, null)
					}));
				}
				Func<CallSite, object, Type, object> target2 = PremiumScriptBuilder.<>o__31.<>p__1.Target;
				CallSite <>p__2 = PremiumScriptBuilder.<>o__31.<>p__1;
				if (PremiumScriptBuilder.<>o__31.<>p__0 == null)
				{
					PremiumScriptBuilder.<>o__31.<>p__0 = CallSite<Func<CallSite, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "GetType", null, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
					{
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
					}));
				}
				object obj = target2(<>p__2, PremiumScriptBuilder.<>o__31.<>p__0.Target(PremiumScriptBuilder.<>o__31.<>p__0, Expression.Data), int.MaxValue.GetType());
				if (PremiumScriptBuilder.<>o__31.<>p__3 == null)
				{
					PremiumScriptBuilder.<>o__31.<>p__3 = CallSite<Func<CallSite, object, bool>>.Create(Binder.UnaryOperation(CSharpBinderFlags.None, ExpressionType.IsFalse, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
					{
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
					}));
				}
				object obj2;
				if (!PremiumScriptBuilder.<>o__31.<>p__3.Target(PremiumScriptBuilder.<>o__31.<>p__3, obj))
				{
					if (PremiumScriptBuilder.<>o__31.<>p__2 == null)
					{
						PremiumScriptBuilder.<>o__31.<>p__2 = CallSite<Func<CallSite, object, bool, object>>.Create(Binder.BinaryOperation(CSharpBinderFlags.BinaryOperationLogical, ExpressionType.And, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
						{
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null),
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, null)
						}));
					}
					obj2 = PremiumScriptBuilder.<>o__31.<>p__2.Target(PremiumScriptBuilder.<>o__31.<>p__2, obj, PremiumScriptBuilder.Random.Next(0, 2) == 0);
				}
				else
				{
					obj2 = obj;
				...
				object obj3 = obj2;
				if (PremiumScriptBuilder.<>o__31.<>p__6 == null)
				{
					PremiumScriptBuilder.<>o__31.<>p__6 = CallSite<Func<CallSite, object, bool>>.Create(Binder.UnaryOperation(CSharpBinderFlags.None, ExpressionType.IsFalse, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
					{
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
					}));
				}
				object arg2;
				if (!PremiumScriptBuilder.<>o__31.<>p__6.Target(PremiumScriptBuilder.<>o__31.<>p__6, obj3))
				{
					if (PremiumScriptBuilder.<>o__31.<>p__5 == null)
					{
						PremiumScriptBuilder.<>o__31.<>p__5 = CallSite<Func<CallSite, object, object, object>>.Create(Binder.BinaryOperation(CSharpBinderFlags.BinaryOperationLogical, ExpressionType.And, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
						{
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null),
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
						}));
					}
					Func<CallSite, object, object, object> target3 = PremiumScriptBuilder.<>o__31.<>p__5.Target;
					CallSite <>p__3 = PremiumScriptBuilder.<>o__31.<>p__5;
					object arg = obj3;
					if (PremiumScriptBuilder.<>o__31.<>p__4 == null)
					{
						PremiumScriptBuilder.<>o__31.<>p__4 = CallSite<Func<CallSite, object, int, object>>.Create(Binder.BinaryOperation(CSharpBinderFlags.None, ExpressionType.GreaterThanOrEqual, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
						{
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null),
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType | CSharpArgumentInfoFlags.Constant, null)
						}));
					}
					arg2 = target3(<>p__3, arg, PremiumScriptBuilder.<>o__31.<>p__4.Target(PremiumScriptBuilder.<>o__31.<>p__4, Expression.Data, 0));
				}
				else
				{
					arg2 = obj3;
				}
				bool flag5 = target(<>p__, arg2);
				if (flag5)
				{
					if (PremiumScriptBuilder.<>o__31.<>p__9 == null)
					{
						PremiumScriptBuilder.<>o__31.<>p__9 = CallSite<Action<CallSite, List<byte>, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.ResultDiscarded, "AddRange", null, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
						{
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, null),
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
						}));
					}
					Action<CallSite, List<byte>, object> target4 = PremiumScriptBuilder.<>o__31.<>p__9.Target;
					CallSite <>p__4 = PremiumScriptBuilder.<>o__31.<>p__9;
					List<byte> arg3 = Initial;
					if (PremiumScriptBuilder.<>o__31.<>p__8 == null)
					{
						PremiumScriptBuilder.<>o__31.<>p__8 = CallSite<Func<CallSite, Type, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "GetBytes", null, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
						{
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType | CSharpArgumentInfoFlags.IsStaticType, null),
							CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
						}));
					}
					target4(<>p__4, arg3, PremiumScriptBuilder.<>o__31.<>p__8.Target(PremiumScriptBuilder.<>o__31.<>p__8, typeof(BitConverter), Expression.Data));
					VMTable = VMTable + Index + "=(gBits32());";
				}
				else
				{
			...
			Bytes = Initial.Concat(Bytes).ToList<byte>();
			string Compressed = Compression.CompressedToString(Compression.Compress(Bytes.ToArray()), this.ObfuscationSettings);
			Source = Source.Replace("PSU_VM_TABLE", "({" + VMTable + "})").Replace("PSU_BYTECODE", Compressed);
			Source = this.ExpandNumberStatements(Source);
			Match Match2;
			string Replacement2;
			for (int SearchPosition2 = 0; SearchPosition2 < Source.Length; SearchPosition2 += Match2.Index + Replacement2.Length)
			{
				string Substring2 = Source.Substring(SearchPosition2);
				Match2 = Regex.Match(Substring2, "PSU_LUA_GENERATION");
				bool success2 = Match2.Success;
				if (!success2)
				{
					break;
				}
				Replacement2 = this.<BuildScript>g__GenerateCode|31_0();
				Source = Source.Substring(0, SearchPosition2 + Match2.Index) + Replacement2 + Source.Substring(SearchPosition2 + Match2.Index + Match2.Length);
			}
			...
			Process.Start();
			Process.WaitForExit();
			Source = File.ReadAllText(Path.Combine(Location, "Output.lua"), PremiumScriptBuilder.LuaEncoding);
			Source = Source.Replace("[.", "[0.");
			Source = Utility.FinalReplaceStrings(Source);
			File.WriteAllText(Path.Combine(Location, "Output.lua"), Source, PremiumScriptBuilder.LuaEncoding);
			return Source;
		}

		[CompilerGenerated]
		internal static string <GenerateDeserializer>g__GetInlinedOrDefault|27_0(string ToInline, string Inlined, string Function, dynamic XORKey)
		{
			bool flag = PremiumScriptBuilder.Random.Next(1, 2) == 0;
			string result;
			if (flag)
			{
				if (PremiumScriptBuilder.<>o__27.<>p__2 == null)
				{
					PremiumScriptBuilder.<>o__27.<>p__2 = CallSite<Func<CallSite, object, string>>.Create(Binder.Convert(CSharpBinderFlags.None, typeof(string), typeof(PremiumScriptBuilder)));
				}
				Func<CallSite, object, string> target = PremiumScriptBuilder.<>o__27.<>p__2.Target;
				CallSite <>p__ = PremiumScriptBuilder.<>o__27.<>p__2;
				if (PremiumScriptBuilder.<>o__27.<>p__1 == null)
				{
					PremiumScriptBuilder.<>o__27.<>p__1 = CallSite<Func<CallSite, string, string, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "Replace", null, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
					{
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType, null),
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.UseCompileTimeType | CSharpArgumentInfoFlags.Constant, null),
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
				...
				Func<CallSite, string, string, object, object> target2 = PremiumScriptBuilder.<>o__27.<>p__1.Target;
				CallSite <>p__2 = PremiumScriptBuilder.<>o__27.<>p__1;
				string arg = Function + "\n" + Inlined;
				string arg2 = "XOR_KEY";
				if (PremiumScriptBuilder.<>o__27.<>p__0 == null)
				{
					PremiumScriptBuilder.<>o__27.<>p__0 = CallSite<Func<CallSite, object, object>>.Create(Binder.InvokeMember(CSharpBinderFlags.None, "ToString", null, typeof(PremiumScriptBuilder), new CSharpArgumentInfo[]
					{
						CSharpArgumentInfo.Create(CSharpArgumentInfoFlags.None, null)
					}));
				}
				result = target(<>p__, target2(<>p__2, arg, arg2, PremiumScriptBuilder.<>o__27.<>p__0.Target(PremiumScriptBuilder.<>o__27.<>p__0, XORKey)));
			}
			else
			{
				result = ToInline;
		...
		[CompilerGenerated]
		private string <GenerateVM>g__FormatVMHandle|28_0(VOpCode Virtual)
		{
		...
		[CompilerGenerated]
		private string <GenerateVM>g__FormatEnum|28_1(int Enum)
		{
			return this.RandomizeNumberStatement((long)Enum);
		}

		[CompilerGenerated]
		private string <GenerateVM>g__GetString|28_2(List<int> OpCodes)
		{
			string String = "";
			bool flag = OpCodes.Count == 1;
			if (flag)
			{
				string Obfuscated = this.<GenerateVM>g__FormatVMHandle|28_0(this.Virtuals[OpCodes[0]]);
				String += Obfuscated;
			}
			else
			{
					...
					if (num2 != 0)
					{
						if (num2 == 1)
						{
							String = string.Concat(new string[]
							{
								String,
								"if (Enum == ",
								this.<GenerateVM>g__FormatEnum|28_1(this.Virtuals[OpCodes[0]].VIndex),
								") then\n",
								this.<GenerateVM>g__FormatVMHandle|28_0(this.Virtuals[OpCodes[0]])
							});
							String = string.Concat(new string[]
							{
								String,
								"elseif (Enum <= ",
								this.<GenerateVM>g__FormatEnum|28_1(this.Virtuals[OpCodes[1]].VIndex),
								") then\n",
								this.<GenerateVM>g__FormatVMHandle|28_0(this.Virtuals[OpCodes[1]])
							});
							String += "end;";
						}
					}
				...
				else
				{
					...
					String = String + "if (Enum <= " + this.<GenerateVM>g__FormatEnum|28_1(Sorted[0].Last<int>()) + ") then ";
					String += this.<GenerateVM>g__GetString|28_2(Sorted[0]);
					String += "else";
					String += this.<GenerateVM>g__GetString|28_2(Sorted[1]);
				}
			}
			return String;
		}
		...
		private string <BuildScript>g__GenerateCode|31_0()
		{
			...
			{
				switch (PremiumScriptBuilder.Random.Next(0, 3))
				{
				case 0:
		...
		private List<PremiumScriptBuilder.Expression> Expressions = new List<PremiumScriptBuilder.Expression>();
		...
		private Dictionary<dynamic, PremiumScriptBuilder.Expression> ExpressionMap = new Dictionary<object, PremiumScriptBuilder.Expression>();

		private List<PremiumScriptBuilder.Expression> NumberExpressions = new List<PremiumScriptBuilder.Expression>();

		private Dictionary<long, PremiumScriptBuilder.Expression> NumberExpressionMap = new Dictionary<long, PremiumScriptBuilder.Expression>();
